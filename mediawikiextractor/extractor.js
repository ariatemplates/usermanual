...
var directory_mappings = {
    ...
    "Core_Layer_-_A_Javascript_Framework" :     { dir: "core",                          name: "index" },
    "Core_Layer_Configuration" :                { dir: "core/advanced",                 name: "core_layer_configuration" },
    "Creating_A_Custom_Widgets_Library" :       { dir: "widgets/custom_widgets_lib",    name: "index" } ,
    ...
    "Introduction" :                            { dir: "intro",                         name: "index" },
    ...
    "Templating_Layer_-_A_Template_Engine" :    { dir: "templates" ,                    name: "index" },
    ...
    "The_Aria_Templates_Widgets_Collection" :   { dir: "widgets/aria_widgets_lib" ,     name: "index" },
    "The_HTML_Widgets_Library" :                { dir: "widgets/html_widgets_lib" ,     name: "index" },
    ...
    "Widgets" :                                 { dir: "widgets" ,                      name: "index" },
