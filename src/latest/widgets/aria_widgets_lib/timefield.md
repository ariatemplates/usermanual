...
<script src='http://snippets.ariatemplates.com/snippets/%VERSION%/widgets/timefield/Snippet.tpl' defer></script>
...
<iframe class='samples' src='http://snippets.ariatemplates.com/samples/%VERSION%/widgets/timefield/' />